...
method_configs["bakedangelo"] = Config(
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=BakedAngeloModelConfig(
            ...
            beta_anneal_max_num_iters=300_000,
        ),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
            "scheduler": MultiStepSchedulerConfig(max_steps=300_000),
        },
        "fields": {
            "optimizer": AdamWOptimizerConfig(lr=1e-3, eps=1e-15, weight_decay=1e-2),
            "scheduler": MultiStepWarmupSchedulerConfig(warm_up_end=3000, milestones=[200_000, 300_000], gamma=0.1),
        },
        "field_background": {
            "optimizer": AdamWOptimizerConfig(lr=1e-3, eps=1e-15),
            "scheduler": MultiStepWarmupSchedulerConfig(warm_up_end=3000, milestones=[100_000, 200_000], gamma=0.1),
        },
    },
